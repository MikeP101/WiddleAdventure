...
class Actor extends Sprite{
    ...
    faint(){
        document.querySelector('#dialogueBox').innerHTML = this.name + ' defeated!'
    ...
    attack ({attack, recipient, renderedSprites}){
        ...
        document.querySelector('#dialogueBox').innerHTML = this.name + ' used ' + attack.name //this displays the dialogue box with attack info
